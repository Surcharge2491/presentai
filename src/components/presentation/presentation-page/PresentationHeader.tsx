...
import PresentAILogo from "@/components/globals/presentai-logo";
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Link href="/" className="h-max">
              <PresentAILogo className="h-10 w-[7.5rem] cursor-pointer transition-transform duration-100 active:scale-95"></PresentAILogo>
            </Link>
          </motion.div>
        </div>
